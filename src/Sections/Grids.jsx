...
const Grids = () => {
	return (
        <>
		<section className="lg:p-40 sm:p-20 w-full flex justify-center flex-col space-y-5">
			<div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 font-roboto font-bold">
				{/* Large screens (3 columns) */}

                {/* 1 */}
				<div className="p-4 flex justify-center flex-col items-center space-y-4 text-center">
					<div className="bg-white shadow-xl p-4     rounded-full w-fit">
						<svg
							width="32"
							height="28"
							viewBox="0 0 32 28"
					...
					<p className="text-[#1f2a4b;] text-xl ">
						Getting started
					</p>
                    <p className="text-[#6e7898]  text-[12px]">Connect your payment card and now your ready to swipe your way through checkouts</p>
				</div>
{/* 2 */}
<div className="p-4 flex justify-center flex-col items-center space-y-4 text-center">
					<div className="bg-white shadow-xl p-4     rounded-full w-fit">
                    ...
                    <p className="text-[#6e7898]  text-[12px]">Earn 0.5% on all your transactions - withdraw anytime</p>
				</div>
{/* 3 */}
<div className="p-4 flex justify-center flex-col items-center space-y-4 text-center">
					<div className="bg-white shadow-xl p-4     rounded-full w-fit">
...
Withdraw Anytime - 24/7/365
                    ...
                    <p className="text-[#6e7898]  text-[12px]">Withdraw money directly to over 11,500 U.S. banks and credit unions</p>
				</div>
                ...
                <div className="p-4 flex justify-center flex-col items-center space-y-4 text-center">
                    ...
                    <p className="text-[#6e7898]  text-[12px]">No U.S. bank account? No problem - deposit and withdraw using cryptocurrencies from anywhere in the world.</p>
				</div>
                {/* 5 */}
                <div className="p-4 flex justify-center flex-col items-center space-y-4 text-center">
					<div className="bg-white shadow-xl p-4     rounded-full w-fit">
                    ...
                    <p className="text-[#6e7898]  text-[12px]">Your money is stored in a hyper-secure, non-custodial cryptocurrency wallet. Learn more</p>
				</div>
                {/* 6 */}
                <div className="p-4 flex justify-center flex-col items-center space-y-4 text-center">
					<div className="bg-white shadow-xl p-4     rounded-full w-fit">
                    ...
                    <p className="text-[#6e7898]  text-[12px]">Your money is managed on the Ethereum blockchain through 100% open-source, independently audited code</p>
				</div>
			</div>
            <hr className='border-[1px] border-[#6e7898] md:px-0   px-8   ' />
		</section>
