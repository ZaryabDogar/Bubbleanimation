			...
			<section className="lg:p-40 sm:p-20 w-full flex justify-center flex-col space-y-5">
				<div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 font-roboto font-bold">
					...
					<div className="p-4 flex justify-center flex-col items-center space-y-4 text-center">
						...
						<p className="text-[#1f2a4b;] text-xl ">Getting started</p>
						<p className="text-[#6e7898]  text-[12px]">
					...
					<div className="p-4 flex justify-center flex-col items-center space-y-4 text-center">
						...
						<p className="text-[#1f2a4b;] text-xl ">Cashback on purchases</p>
						<p className="text-[#6e7898]  text-[12px]">
					...
					<div className="p-4 flex justify-center flex-col items-center space-y-4 text-center">
						...
						<p className="text-[#6e7898]  text-[12px]">
							Withdraw money directly to over 11,500 U.S. banks and credit
							unions
						</p>
					</div>
					...
					<div className="p-4 flex justify-center flex-col items-center space-y-4 text-center">
						...
						<p className="text-[#1f2a4b;] text-xl ">Radical Transparency</p>
						<p className="text-[#6e7898]  text-[12px]">
